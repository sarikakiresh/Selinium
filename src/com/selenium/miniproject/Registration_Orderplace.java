...
public class Registration_Orderplace {
	...
	public static void main(String[] args) throws InterruptedException, Exception {
      ...
      Thread.sleep(3000);
		...
		a.moveToElement(color_select).click().build().perform();
		...
		WebElement proceedtocheckout3 = driver.findElement(By.xpath("(//button[@type='submit'])[2]"));
    	...
    	WebElement dresses1 = driver.findElement(By.xpath("(//a[@title='Dresses'])[2]"));
